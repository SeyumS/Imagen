  ...
  return (
    <div className='user-container'>
      ...
      <div className="user-profile-container">
       <div className='user-image-container'><img src={city} className='user-profile-picture'/>
       </div>
       <div className='u-user-name-container'><p className='u-user-name'>User</p></div>
       </div>
      
      <div className="u-user-stats"> <p className="u-user-stat">21k Follower</p>
      ...
      <button className='u-button'>Follow</button>
      </div>
